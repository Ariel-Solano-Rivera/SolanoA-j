...
a persistence unit "solanojsPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "solanojs/pom.xml":
...
artifact ("solanojs.war") is already built. You can build
